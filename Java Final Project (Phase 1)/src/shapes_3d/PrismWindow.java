	...
	public PrismWindow() {
		...
		btnCalculateButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Double area = (pi * converted_radiusField_txt) * (converted_radiusField_txt + Math.sqrt(Math.pow(converted_heightField_txt, 2) + Math.pow(converted_radiusField_txt, 2)));
