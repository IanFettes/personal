...
public class DegToRadians extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DegToRadians frame = new DegToRadians();
	...
	public DegToRadians() {
		...
		JLabel lbl_degrees = new JLabel("Enter degrees");
		lbl_degrees.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lbl_degrees.setBounds(10, 10, 135, 17);
		...
		JLabel lbl_area = new JLabel("Radians:");
		...
		JLabel lbl_inSquared = new JLabel("rad");
		...
		btnCalculateButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Double degrees = Double.parseDouble(sideLength_field.getText());
				final Double pi = 3.14;
				Double radians = degrees * (pi / 180);
				textPane.setText(radians.toString());
