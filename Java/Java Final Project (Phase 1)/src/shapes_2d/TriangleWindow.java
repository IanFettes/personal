	...
	public TriangleWindow() {
		...
		btnCalculateButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Double converted_lengthField_txt = Double.parseDouble(aField.getText());
				Double converted_widthField_txt = Double.parseDouble(bField.getText());
				Double area = (converted_lengthField_txt * converted_widthField_txt) / 2;
